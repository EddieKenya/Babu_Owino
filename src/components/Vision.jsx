...
const Vision = () => {
  return (
    <div className="min-h-screen bg-white font-sans text-slate-900">
      ...
      {/* STRATEGIC OVERVIEW */}
      <section className="py-16 md:py-24 px-6 md:px-24 bg-slate-50 border-b border-slate-200">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <p className="text-lg md:text-2xl text-slate-600 leading-relaxed font-light italic px-2">
      ...
      <section className="py-16 md:py-24 px-6 md:px-24">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row gap-12 md:gap-16 items-start">
          <div className="w-full md:w-1/2 md:sticky md:top-24">
            <h2 className="text-3xl md:text-4xl font-serif font-bold mb-6 md:mb-8 text-[#334155] border-l-8 border-blue-600 pl-6">
            ...
            <div className="space-y-6 text-slate-700 text-base md:text-lg leading-relaxed">
              ...
              <ul className="space-y-4 font-medium">
                ...
                <li className="flex gap-3"><span className="text-blue-600">●</span> Estate Internal Connectivity: Prioritizing the paving of Eastlands "Last-Mile" lanes.</li>
              </ul>
            </div>
          </div>
          <div className="w-full md:w-1/2 mt-8 md:mt-0">
            <img src="/tarmacking.png" alt="Infrastructure Blueprint" className="w-full h-auto shadow-xl md:shadow-2xl mb-8" />
            <div className="bg-slate-900 p-6 md:p-8 text-white">
              ...
              <p className="text-sm font-light leading-loose">
                ...
                values and reducing vehicle maintenance costs.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-16 md:py-24 px-6 md:px-24 bg-slate-900 text-white overflow-hidden">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row-reverse gap-12 md:gap-16 items-center">
          <div className="w-full md:w-1/2">
            <h2 className="text-3xl md:text-4xl font-serif font-bold mb-6 md:mb-8">Defending the <br /> Right to Shelter</h2>
            <div className="space-y-6 text-slate-300 text-base md:text-lg leading-relaxed">
              ...
              <p>
                ...
                neighborhoods from predatory evictions.
              </p>
            </div>
          </div>
          <div className="w-full md:w-1/2 mt-8 md:mt-0">
            <img src="/affordable.png" alt="Housing Rights" className="w-full h-auto shadow-xl md:shadow-2xl relative z-10" />
          </div>
        </div>
      </section>
      ...
      <section className="py-16 md:py-24 px-6 md:px-24">
        <div className="max-w-7xl mx-auto flex flex-col md:grid md:grid-cols-2 gap-12 md:gap-16 items-center">
          <div className="w-full order-2 md:order-1">
            <img src="/kazi.png" alt="Kazi kwa Vijana" className="w-full h-auto shadow-xl md:shadow-2xl grayscale hover:grayscale-0 transition-all duration-700" />
          ...
          <div className="w-full order-1 md:order-2">
            <h2 className="text-3xl md:text-4xl font-serif font-bold mb-6 md:mb-8 text-[#334155]">Kazi kwa Vijana 2.0: <br /> Dignity in Labor</h2>
            <div className="space-y-6 text-slate-700 text-base md:text-lg leading-relaxed">
              <p>
              ...
              <div className="grid grid-cols-1 gap-4 mt-8">
                <div className="p-4 border-l-4 border-blue-600 bg-slate-50">
                  <h4 className="font-bold mb-1">30% Direct Procurement</h4>
                  <p className="text-xs md:text-sm">Contracts go directly to registered youth groups in each ward.</p>
                </div>
                <div className="p-4 border-l-4 border-blue-600 bg-slate-50">
                  <h4 className="font-bold mb-1">Babu Tech-Hubs</h4>
                  <p className="text-xs md:text-sm">24/7 Digital Hubs with high-speed internet for global remote work.</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="py-16 md:py-24 px-6 md:px-24 bg-slate-50">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row gap-12 md:gap-16 items-start">
          <div className="w-full md:w-1/2 md:sticky md:top-24">
            <h2 className="text-3xl md:text-4xl font-serif font-bold mb-6 md:mb-8 text-[#334155]">Waste-To-Energy <br /> Revolution</h2>
            <p className="text-base md:text-lg text-slate-700 leading-relaxed mb-6">
              Garbage in Nairobi is a goldmine. My <strong>Garbage Collection</strong> strategy moves away from the "collect and dump" failure.
            </p>
            <div className="bg-white p-6 shadow-md border-r-4 border-blue-600">
              <h4 className="font-bold text-blue-600 mb-2 text-sm md:text-base">The Dandora Industrialization Plan</h4>
              <p className="text-xs md:text-sm text-slate-600 italic">
                Converting 2,500 tons of daily waste into 50MW of clean energy for the city’s grid.
              </p>
            </div>
          </div>
          <div className="w-full md:w-1/2 mt-8 md:mt-0">
            <img src="/garbage.png" alt="Waste Management" className="w-full h-auto shadow-xl md:shadow-2xl" />
          </div>
        </div>
      </section>
      ...
      <section className="py-16 md:py-24 px-6 md:px-24">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row-reverse gap-12 md:gap-16 items-center">
          <div className="w-full md:w-1/2">
            <h2 className="text-3xl md:text-4xl font-serif font-bold mb-6 md:mb-8 text-[#334155]">Seamless Transit <br /> & Smart Traffic</h2>
            <p className="text-base md:text-lg text-slate-700 leading-relaxed mb-6">
            ...
            <ul className="space-y-4">
              <li className="bg-slate-50 p-4 md:p-6 rounded-lg">
                <span className="block font-bold text-blue-600 mb-1 text-sm md:text-base">AI-Traffic Control</span>
                <span className="text-xs md:text-sm">Centralized AI-brain that manages light timings based on vehicle density.</span>
              </li>
              <li className="bg-slate-50 p-4 md:p-6 rounded-lg">
                <span className="block font-bold text-blue-600 mb-1 text-sm md:text-base">BRT Core Completion</span>
                <span className="text-xs md:text-sm">Dedicated electric bus lanes to move 5x more people in half the time.</span>
              </li>
            </ul>
          </div>
          <div className="w-full md:w-1/2 mt-8 md:mt-0">
            <img src="/transport.png" alt="Transport Vision" className="w-full h-auto shadow-xl md:shadow-2xl" />
          </div>
        </div>
      </section>
